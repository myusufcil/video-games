...
class RecyclerviewAdapterConstant {
    ...
    object TYPES {
        ...
        const val TYPE_GAMES_DETAIL_PARAGRAPH = 6
    }
    ...
    var binderFactoryMap = mutableMapOf(
        ...
        TYPES.TYPE_GAMES_DETAIL_PARAGRAPH to GamesDetailParagraphViewHolder.BinderFactory()
    )
    ...
    var holderFactoryMap = mutableMapOf(
        ...
        TYPES.TYPE_GAMES_DETAIL_PARAGRAPH to GamesDetailParagraphViewHolder.HolderFactory()
    )
}
